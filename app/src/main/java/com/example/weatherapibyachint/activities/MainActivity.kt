package com.example.weatherapibyachint.activities
...
import com.example.weatherapibyachint.R
import com.example.weatherapibyachint.databinding.ActivityMainBinding
import com.example.weatherapibyachint.models.WeatherModel
import com.example.weatherapibyachint.utilies.ApiUtilities
...
class MainActivity : AppCompatActivity() {
    ...
    private val apiKey = "aa2688e9886403610850cf4896c0cdfd"
    ...
    override fun onRequestPermissionsResult(
        ...
        if(requestCode == LOCATION_REQUEST_CODE){
            if(grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(this,"permit request to enable privilege",Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private fun setData(body:WeatherModel){
        binding.apply {
            ...
            temp.text = ""+k2c(body?.main?.temp_min!!)+"°"
